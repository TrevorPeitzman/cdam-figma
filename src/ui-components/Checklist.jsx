...
export default function Checklist(props) {
  ...
  const containerOnClick = useNavigateAction({
    type: "url",
    url: `${"/CommandDetail/"}${checklist?.id}`,
  });
  const paragraphOnClick = useNavigateAction({
    target: "_blank",
    type: "url",
    url: `${"mailto:"}${checklist?.commandPOC}`,
  });
  return (
    <Flex
      gap="0"
      ...
      >
        ...
        >
          <Text
            ...
            padding="0px 0px 0px 0px"
            whiteSpace="pre-wrap"
            children={checklist?.commandName}
