...
export default function ChecklistItemCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new ChecklistItem(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "ChecklistItemCreateForm")}
      {...rest}
    >
      <TextField
        label="Item name"
